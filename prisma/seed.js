...
async function main() {
    ...
    await prisma.$transaction(allPermissions.map((permission) => prisma.userRolePermission.create({
        data: {
    ...
    await prisma.report.create({
        data: {
            ...
            report_description: 'User melakukan pelanggaran etika saat meeting online.',
    ...
    const report1 = await prisma.report.create({
        data: {
            ...
            report_description: 'Saya menemukan performa mesin RTU-01 menurun drastis sejak kemarin.',
    ...
    const report2 = await prisma.report.create({
        data: {
            ...
            report_description: 'Ada kebocoran gas di area RTU-03, perlu penanganan segera!',
            status: client_1.ReportStatus.PENDING,
        },
    });
    const report3 = await prisma.report.create({
        data: {
            ...
            report_description: 'Sensor tekanan di RTU-05 menunjukkan angka tidak stabil.',
    ...
    const reply1_2 = await prisma.reportReply.create({
        data: {
            ...
            message: 'Sudah saya cek flow rate dan pressure, keduanya di bawah normal.',
    ...
    const reply2_1 = await prisma.reportReply.create({
        data: {
            reportId: report2.id,
            userId: supervisor1.id,
            message: 'Laporan diterima! Tim evakuasi sedang menuju lokasi. Mohon jauhi area tersebut!',
    ...
    const reply3_2 = await prisma.reportReply.create({
        data: {
            ...
            message: 'Sudah normal kembali. Kalibrasi terakhir menunjukkan akurasi 99%.',
    ...
    const report4 = await prisma.report.create({
        data: {
            ...
            reportFromId: staff2.id,
            reportCategoryId: performanceCategory.id,
            report_description: 'Ada anomaly pada data logger RTU-02 sejak update terakhir.',
            status: client_1.ReportStatus.REVISION,
        },
    });
    ...
    const reply4_2 = await prisma.reportReply.create({
        data: {
            ...
            message: 'Data flow rate melompat-lompat padahal tidak ada perubahan pada flow actual.',
    ...
    const reply4_4 = await prisma.reportReply.create({
        data: {
            ...
            message: 'Berikut grafiknya: [image-link]. Terlihat spike tidak wajar setiap 2 jam.',
